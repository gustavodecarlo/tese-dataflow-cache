...
&&  rm -fr /opt/spark-3.1.2-bin-hadoop3.2 
...
ADD https://repo1.maven.org/maven2/com/google/cloud/bigdataoss/gcs-connector/hadoop3-2.2.5/gcs-connector-hadoop3-2.2.5-shaded.jar $SPARK_HOME/jars
RUN chmod 644 $SPARK_HOME/jars/gcs-connector-hadoop3-2.2.5-shaded.jar
...
RUN chmod 644 $SPARK_HOME/jars/spark-cassandra-connector_2.12-3.1.0.jar
ADD https://repo1.maven.org/maven2/io/delta/delta-core_2.12/1.0.0/delta-core_2.12-1.0.0.jar $SPARK_HOME/jars
RUN chmod 644 $SPARK_HOME/jars/delta-core_2.12-1.0.0.jar
ADD https://repo1.maven.org/maven2/io/delta/delta-contribs_2.12/1.0.0/delta-contribs_2.12-1.0.0.jar $SPARK_HOME/jars
RUN chmod 644 $SPARK_HOME/jars/delta-contribs_2.12-1.0.0.jar
